...
Lockit.UI_SETTING_IN_DELVE_WIDGET_CONTROL_TOOLTIP = "Aktiviert ein Widget, welches in den Tiefen angezeigt wird. It serves as a remainder and a quick-cast menu for the Bounty Map, Nemesis Lure, and more."
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_NAME = "Anzeigeposition"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_TOOLTIP = "Bestimmt wo das Widget angezeigt werden soll."
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_LEFT_NAME = "linke Seite"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_LEFT_DESCRIPTION = "Das Widgeht wird auf der linke Seite der Questzielverfolgung angezeigt."
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_RIGHT_NAME = "rechte Seite"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_RIGHT_DESCRIPTION = "Das Widgeht wird auf der rechten Seite der Questzielverfolgung angezeigt."
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_CUSTOM_NAME = "benutzerdefiniert"
Lockit.UI_SETTING_IN_DELVE_WIDGET_DISPLAY_RULE_OPTION_CUSTOM_DESCRIPTION = "Das Widget kann frei auf dem Bildschirm bewegt werden. |cnGREEN_FONT_COLOR:Rechts klicken|r und das Widget kann bewegt werden."
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_NAME = "Button Ausrichtung"
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_TOOLTIP = "Bestimmt wie die Buttons im Widget angeorndet sind."
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_OPTION_VERTICAL_NAME = "vertikale Ausrichtung"
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_OPTION_VERTICAL_DESCRIPTION = "Die Buttons werden vertikal ausgerichtet."
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_OPTION_HORIZONTAL_NAME = "horizontale Ausrichtung"
Lockit.UI_SETTING_IN_DELVE_WIDGET_LAYOUT_OPTION_HORIZONTAL_DESCRIPTION = "Die Buttons werden horizontal ausgerichtet."
...
Lockit.UI_SETTING_LOGS_NAME = "aktiviere Debugmeldungen"
Lockit.UI_SETTING_LOGS_TOOLTIP = "Im Chat werden Debugmeldungen angezeigt. Wird für Entwicklungs- und Testzwecke genutzt."
