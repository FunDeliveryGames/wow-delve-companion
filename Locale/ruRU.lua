...
Lockit.UI_SETTING_TOOLTIP_EXTENSION_TOOLTIP = "Отображать дополнительную информацию во всплывающих подсказках (например, был ли на этой неделе получен предмет |cnITEM_EPIC_COLOR:Клад участника вылазки|r)."
