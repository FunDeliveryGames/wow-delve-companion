...
-- Настройки
lockit["ui-settings-missing-addon-title"] = "Необходимый аддон отсутствует: %s" -- %s: название аддона, например DelveCompanion
...
lockit["ui-settings-tomtom-description"] = "Использовать точки TomTom вместо маркеров карты Blizzard."
