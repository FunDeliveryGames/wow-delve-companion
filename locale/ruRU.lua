...
lockit["ui-gilded-stash-bountiful-note"] = "Появляется только на |cnNORMAL_FONT_COLOR:11-ом Уровне|r Многообещающих Вылазок|A:delves-bountiful:16:16|a."
...
-- Настройки
lockit["ui-settings-missing-addon-title"] = "Отсутствует необходимый аддон: %s" -- %s: Имя аддона. Например, DelveCompanion
...
lockit["ui-settings-dashboard-overview"] = "Интерфейс вылазок: Отображать раздел обзора (Позолоченный тайник, Многообещающая Вылазка)."
